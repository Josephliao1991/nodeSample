...
var csvFile = require('./csv/csvFile.js');
  ...
  mongoose.connect('mongodb://10.240.17.142:80/oldFamilyDatabase');
  ...
  app.get('/',function(request,response){
    response.end("Hello world, This is iNeDot Server! And Your Son Of Bitch!");
  });
...
/*===========================HOME ALERT API==================================*/
  ...
  app.post('/array', function (request, response) {
    ...
    console.log("JSON.switch: "+array.switch);
    console.log("JSON.switch.temp: "+array.switch.temp);
